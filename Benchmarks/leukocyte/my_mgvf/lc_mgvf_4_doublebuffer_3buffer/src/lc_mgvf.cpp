...
extern "C"{
void buffer_load(int flag, int k, float imgvf_dest[GRID_COLS * (TILE_ROWS + 2)], float *imgvf_src, float I_dest[GRID_COLS * TILE_ROWS], float *I_src){
    buffer_load_imgvf(flag, k, imgvf_dest, imgvf_src);
    buffer_load_I(flag, k, I_dest, I_src);
}    
}
